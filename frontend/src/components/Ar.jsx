...
function Ar() {
    ...
    const authorProd = products.filter(item => item.author === "ARUNDHATI ROY")
  ...
  return (
    <div>
        <Nav/>
        <div className="cb1">
            <h1 className="cb2">ARUNDHATI ROY</h1>
            <img className="cb3" width={250} height={250}src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/7b/Arundhati_Roy_W.jpg/330px-Arundhati_Roy_W.jpg"  />
        <h4 className="cb4">
        Suzanna Arundhati Roy (born 24 November 1961)is an Indian author best known for her novel The God of Small Things, which won the Booker Prize for Fiction in 1997 and became the best-selling book by a non-expatriate Indian author.
