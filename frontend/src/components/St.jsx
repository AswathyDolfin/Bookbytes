...
function St() {
    ...
    const authorProd = products.filter(item => item.author === "SHASHI THAROOR")
  ...
  return (
    <div>
        <Nav/>
        <div className="cb1">
            <h1 className="cb2">SHASHI THAROOR</h1>
            <img className="cb3" width={250} height={250}src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a6/Sasi_Tharoor_2021_at_Kollam.jpg/330px-Sasi_Tharoor_2021_at_Kollam.jpg"  />
        <h4 className="cb4">
